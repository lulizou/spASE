...
This vignette replicates our resultsfor the Smart-seq2 with UMIs and
Smart-seq3 data.

## Smart-seq2 with UMIs data

First download the data - Smart-seq2 w/ UMI data is already formatted correctly 
as is.
...
of all cells (change number of cores used if necessary):
...
and produces plots for the desired genes.
