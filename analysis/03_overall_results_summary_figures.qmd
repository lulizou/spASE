...
load('cside_spase_combined_cere4_visium_df_5.RData')
...
cere_4 <- readRDS('spase_results_visium_cere4.rds')
```
...
cere_4_spct_res <- readRDS('cside_spase_combined_cere4_visium_df_5.rds')
```
