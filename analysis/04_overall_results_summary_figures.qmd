...
Note that \textit{Sst} is detected as significant within Interneuron for Mouse 3; however, this goes
away when controlling for the Interneuron sub-type located in the cluster of cells with
high Sst expression. Thus, it is not included in the final table.
