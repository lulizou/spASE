...
hippo1 <- readRDS('rctd_hippo_1.rds')
...
saveRDS(hippo1_intercept, file='results_celltype_intercept_hippo_1_df_5.rds')
...
hippo1 <- run.CSIDE.nonparam(hippo1, df = 5, cell_types = cell_types,
                             ...
                             test_genes_sig = T)
saveRDS(hippo1, file='results_celltype_hippo_1_df_5.rds')
