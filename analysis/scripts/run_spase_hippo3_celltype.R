...
hippo3 <- readRDS('rctd_hippo_3.rds')
...
saveRDS(hippo3_intercept, file='results_celltype_intercept_hippo_3_df_5.rds')
...
hippo3 <- run.CSIDE.nonparam(hippo3, df = 5, cell_types = cell_types,
                              ...
                              test_genes_sig = T)
saveRDS(hippo3, file='results_celltype_hippo_3_df_5.rds')
