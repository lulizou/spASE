...
cere4_intercept <- run.CSIDE.intercept(cere4, cell_types = cell_types,
 ...
 saveRDS(cere4_intercept, file='results/results_celltype_intercept_cere_4_visium_df_5.rds')
...
cere4 <- run.CSIDE.nonparam(cere4, df = 5, cell_types = cell_types,
                             ...
                             test_genes_sig = T, doublet_mode = F)
saveRDS(cere4, file='results/results_celltype_cere_4_visium_df_5.rds')
